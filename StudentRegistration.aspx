...
<body>
    ...
    <asp:DropDownList ID="ddlCourses" runat="server" 
        style="z-index: 1; left: 184px; top: 267px; position: absolute;" DataSourceID="SqlDataSource1" DataTextField="CourseName" DataValueField="CourseID">
    </asp:DropDownList>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\university.mdf;Integrated Security=True" ProviderName="System.Data.SqlClient" SelectCommand="SELECT [CourseID], [CourseName] FROM [Courses]"></asp:SqlDataSource>
